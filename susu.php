...
echo "\e[95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo "\e[93m            \e[96m  HONGKONG \e[93m \n";
echo "\e[96m  ==============================================\n";
echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
...
echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
	goto login;
login:
echo "\e[96m▬▬▬ LANGSUNG DI LEBOKNE  ▬▬▬▬▬\n";
$pass =  ( '║ User Login : ' );
echo "\033[30;40m";
...
else
{
		echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";	
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
		echo "\e[96m[🚫]        \e[91mWES TAK OMONGI         \e[96m [🚫]\n";
	        echo "\e[96m[🚫]              \e[91mLEBOKNE WAE        \e[96m [🚫]\n";
		echo "\e[96m[🚫]           \e[91mMASIH AJA NGEYEL LU      \e[96m [🚫]\n";
	        echo "\e[96m[🚫] \e[91mBELOM PERNAH DI ENTUP TAWON YA LO \e[96m [🚫]\n";
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
...
// function change(){
        ...
        echo color("white","📶▶️ OTP LHO ")."\n";
        otp:
        echo color("green","💬▶️ OTPNDI COK : ");
        ...
        echo "\n".color("purple","# CLAIM SUSU RONDO ENOM");
        echo "\n".color("yellow","# GEDE BANGET ");
        for($a=1;$a<=3;$a++){
        echo color("purple",".");
        sleep(15);
        }
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("blue","# CLAIM SUSU BOJONE TONGGO");
        echo "\n".color("white","# MONTOK TENAN ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("blue","# CLAIM SUSU PERAWAN");
        echo "\n".color("green","KENYUL_KENYUL");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(15);
        }
        ...
        echo "\n".color("blue","# CLAIM SUSU SAPI");
        echo "\n".color("yellow","# DI SLENTAK NDASMU");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(5);
        }
        ...
        $TOKEN  = "0000000000:7V93cvCvw1DNuTk0Hp1ZFywJGmjiP7aQ";
         ...
         setpin:
         echo "\n".color("white","🔧▶️ SET TOGEL  ? !!!: Y/N ");
         $pilih1 = trim(fgets(STDIN));
         if($pilih1 == "y" || $pilih1 == "Y"){
         //if($pilih1 == "y" && strpos($no, "628")){
         echo color("Blue","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧PIN ANGKANE = 696969 🔧▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"696969"}';
